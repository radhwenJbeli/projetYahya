    ...
    public  void initData(Post p) {
         ...
         ServicePost service=new ServicePost();
          ...
          // p.getChildren().add(lc);
           ...
           FontAwesomeIconView modifc = new FontAwesomeIconView(null);
           ...
           FontAwesomeIconView suppc = new FontAwesomeIconView(null);
          ...
          // VBox p = new VBox();
           ...
           descc.setTranslateY(20);  
            ...
            FontAwesomeIconView envoyer = new FontAwesomeIconView(null);
